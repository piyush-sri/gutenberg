...
-	**Supports:** color (background, gradients, link, text), interactivity (clientNavigation), selectors (root), spacing (margin, padding), splitting, typography (fontSize, lineHeight), ~~className~~
